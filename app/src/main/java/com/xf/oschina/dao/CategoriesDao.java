...
public class CategoriesDao extends AbstractDao<Categories, String> {
    ...
    public static class Properties {
        ...
        public final static Property En_name = new Property(1, String.class, "en_name", false, "EN_NAME");
    ...
    public Categories readEntity(Cursor cursor, int offset) {
        Categories entity = new Categories( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // en_name
    ...
    public void readEntity(Cursor cursor, Categories entity, int offset) {
        ...
        entity.setEn_name(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setName(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setRank(cursor.getInt(offset + 3));
     }
    
    @Override
    protected final String updateKeyAfterInsert(Categories entity, long rowId) {
        return entity.getId();
    }
